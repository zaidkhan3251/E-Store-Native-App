...
const CartReducer=(state=initState,action)=>{
    ...
    switch(action.type){
        ...
        if(check){
            ...
            const  tprice=state.totalPrice + product.qoute * quantity
        ...
        case 'INC':
            ...
            return{
                ...state,totalPrice:state.totalPrice+findpro.qoute,totalQuantities: state.totalQuantities+=1
            }
        case 'DEC':
            findpro=state.products.find(product=>product.id===action.payload);
            index=state.products.findIndex(product=>product.id===action.payload);
            ...
            case 'REMOVE':
                ...
                return{
                    ...state,
                    products: filtered,
                    totalPrice: state.totalPrice-findpro.qoute*findpro.quantity,
